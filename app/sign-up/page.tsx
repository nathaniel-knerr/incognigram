            ...
            <main className="flex-1 flex flex-col items-center justify-center bg-gray-900">
                <form onSubmit={handleSubmit} className="w-full md:w-[65%] flex flex-col items-center bg-white p-4 m-4 md:rounded-2xl">
                    ...
                    <div className="w-full md:w-[65%] flex flex-col p-4">
                        ...
                        <input id="sign-up-email" type="email" value={email} onChange={(e) => setEmail(e.target.value)} className="w-full text-md p-1 border-2 border-black"/>
                    </div>

                    <div className="w-full md:w-[65%] flex flex-col p-4">
                        <label htmlFor="sign-up-password" className="text-md">Password</label>
                        <input id="sign-up-password" type="password" value={password} onChange={(p) => setPassword(p.target.value)} className="w-full text-md p-1 border-2 border-black"/>
                    </div>
